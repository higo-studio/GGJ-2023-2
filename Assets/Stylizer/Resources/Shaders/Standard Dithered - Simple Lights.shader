Shader "Beffio/Standard Dithered - Simple Lights" 
{
	Properties 
	{
		// Standard Properties
	...
	SubShader 
	{
		...
		CGPROGRAM
			...
			#pragma surface StandardSurface Standard fullforwardshadows vertex:DitheringVertex finalcolor:StandardDither noforwardadd
			#pragma target 3.0
