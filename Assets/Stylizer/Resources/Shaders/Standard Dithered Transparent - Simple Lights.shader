Shader "Beffio/Standard Dithered Transparent - Simple Lights" 
{
	Properties 
	{
		// Standard Properties
	...
	SubShader 
	{
		...
		CGPROGRAM
			...
			#pragma surface StandardSurface Standard alphatest:_Cutout vertex:DitheringVertex finalcolor:StandardDither noforwardadd
			#pragma target 3.0
