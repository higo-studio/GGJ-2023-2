Shader "Beffio/Diffuse Dithered Transparent - Soft Lights" 
{
	Properties 
	{
		// Diffuse Properties
	...
	SubShader 
	{
		...
		CGPROGRAM
			#pragma surface LambertSurface Lambert alphatest:_Cutout vertex:DitheringVertex finalcolor:DiffuseDither
			#pragma target 3.0
