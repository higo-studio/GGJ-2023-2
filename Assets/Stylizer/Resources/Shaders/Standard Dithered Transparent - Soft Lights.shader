Shader "Beffio/Standard Dithered Transparent - Soft Lights" 
{
	Properties 
	{
		// Standard Properties
	...
	SubShader 
	{
		...
		CGPROGRAM
			...
			#pragma surface StandardSurface Standard alphatest:_Cutout vertex:DitheringVertex finalcolor:StandardDither
			#pragma target 3.0
